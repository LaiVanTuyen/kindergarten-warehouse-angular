      ...
      <ng-container *ngFor="let item of items(); trackBy: trackByItem">
        ...
        <ng-template #pageBtn>
          <button
            ...
            [class.bg-primary-600]="item === page"
            [class.text-white]="item === page"
            [class.ring-primary-600]="item === page"
            [class.bg-surface]="item !== page"
            [class.text-ink-soft]="item !== page"
            [class.ring-line]="item !== page"
            [class.hover:bg-surface-2]="item !== page"
